...
The "kfr_pooled_pooled_p25" is the social mobility measure which ranks what 

The "foreign_share2010"

The "frac_coll_plus2010"

*describe the important variables i will be looking at 
...
This chart shows there is a strong correlation between foreign share and social mobility in Newark. This is interesting to think about considering that the East Ward has the highest foreign share as well as the highest social mobility score, which we know is highly correlated.
...
Here, we see interestingly enough, the amount of college attainment is not at all correlated with social mobility. There is a correlation of 
...
~interpret the regression line by line
The regression reveals that there is indeed a high impact of black share and foreign share with on social mobility. We also observe that these effects have a high statistical significance.
...
black and foreign share might be counfounders for something else
